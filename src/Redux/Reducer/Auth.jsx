...
export const login = createAsyncThunk('auth/login', async (credentials) => {
  try {
    const response = await axios.post('http://20.121.59.247:3400/api/auth/login', credentials);
...
export const register = createAsyncThunk('auth/register', async (data) => {
  try {
    const response = await axios.post('http://20.121.59.247:3400/api/auth/register', data);
