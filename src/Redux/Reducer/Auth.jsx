...
export const login = createAsyncThunk('auth/login', async (credentials) => {
  try {
    const response = await axios.post('https://gpt.masscle.com/api/auth/login', credentials);
...
export const register = createAsyncThunk('auth/register', async (data) => {
  try {
    const response = await axios.post('https://gpt.masscle.com/api/auth/register', data);
